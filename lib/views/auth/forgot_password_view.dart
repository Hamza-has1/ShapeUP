...
class _ForgotPasswordViewState extends State<ForgotPasswordView> {
  ...
  void _onSubmit() async {
    ...
    final success = await auth.sendRecoveryEmail(email);
    ...
    if (success && mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Recovery code sent! Use OTP code "1234" for mock testing.'),
                      ...
                      GlassContainer(
                        ...
                        child: Column(
                          children: [
                            ...
                            if (_isLoading)
                              const LuxuryLoadingIndicator(message: 'Sending recovery code...')
                            else
                              NeonGradientButton(
                                text: 'Send Code',
                                onPressed: _onSubmit,
